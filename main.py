...
def banner(console):
    ...
    console.print("[bold green]♕ CPMAIZAL[/bold green]: Sharing The Access Key Is Prohibited And Will Be Block.")
    ...
    console.print("[bold yellow]! Note[/bold yellow]: Logout from cpm when using this tool !.", end="\n\n")
