...
__CHANNEL_USERNAME__ = "HzToolsCPM"
__GROUP_USERNAME__   = "HzToolsCPMChat"
...
def banner(console):
    ...
    console.print(f"             [bold green]𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 [/bold green]: [bold cyan]@HzToolsCPM[/bold cyan] 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐂𝐡𝐚𝐭[bold cyan]@HzToolsCPMChat[/bold cyan]") 
    console.print("[bold][red]==================================================================[/red][/bold]")
